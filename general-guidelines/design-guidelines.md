...
| **Part**          | **Description**                                                                                                                                                                               | Format                                  | Example(s)                                                                                                                                                                                                      |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| {DIV}             | Aliaxis division code                                                                                                                                                                         | 2-4 upper-case letters                  | <p>EMEA</p><p>APAC</p><p>AGRP</p><p>NA</p>                                                                                                                                                                      |
| {ENV}             | Code of the environment to which the zone belongs                                                                                                                                             | 3 upper-case letters                    | <p>DEV: Development environment</p><p>TST: Test environment</p><p>PRD: Production environment</p>                                                                                                               |
| {type}            | <p>Type of data the directory stores</p><p>&#x3C;b>&#x3C;/b></p>                                                                                                                              | 4 lower-case letters                    | <p>data: data ingested from source systems</p><p>exec: execution-related data, like pipeline metadata or logs</p>                                                                                               |
| {zone\_code}      | <p>A zone qualifies the layer a data entity belongs to and its properties. For example, data that is ingested in the data platform is stored in the landing zone.</p><p>&#x3C;b>&#x3C;/b></p> | 3 lower-case letters                    | <p>lan: landing zone. This is where ingested data resides</p><p>ods: operational data store</p><p>sda: specific data area</p><p>cda: global (common) data area</p><p>scr: scratch</p><p>adm: administration</p> |
| {source\_code}    | <p>A code is allocated to each source system of data.</p><p>When a source is onboarded, the BICC works on the naming convention to make sure that it is correct.</p><p>&#x3C;b>&#x3C;/b></p>  | Lower-case letters                      | <p>sharepoint</p><p>ax-uk</p><p>germany-sql-2012</p>                                                                                                                                                            |
| {schema}          | <p>Indicates the database schema from where the data is being ingested.<br>When dealing with non-relational databases, the schema can be generic (for example, all).</p>                      | Lower-case letters                      | <p>dbo</p><p>sales</p>                                                                                                                                                                                          |
| {table}           | The name of the table from which data is being ingested                                                                                                                                       | Lower-case letters                      | <p>sales_invoice</p><p>accounts</p>                                                                                                                                                                             |
| {ingestion\_type} | <p>The type of ingestion.</p><p>&#x3C;b>&#x3C;/b></p>                                                                                                                                         | 1 lower-case letter                     | <p>s: snapshot ingestion. The entire table is ingested at every run</p><p>d: delta ingestion. Only new and updated records are ingested.</p>                                                                    |
| {datetime}        | The date when the data was ingested.                                                                                                                                                          | 10 characters in the format: YYYY-MM-DD | 2020-01-01                                                                                                                                                                                                      |
...
This schema should contain all the transactional tables before loading the data into ODS. Example use-case is to load the data in TMP\_LAN evaluate the quality of data before loading into ODS table.

TODO; why this table name convension? Table naming convention: **EMEA\_PRD**\_**ODS.TMP\_LAN.\[ODS TABLE NAME]\_\[ADF Pipeline run id]**
...
Each schema in the data warehouse, depending on the architecture approach (data marts or data products), can represent a business function (Sales, or Marketing), or a data product (for example, Price\_Explorer_,_ or EndToEnd_\__Sales).&#x20;
...
{% hint style="info" %}
Note: It's possible for the {description of the view} to contain details about its intent. For example, a valid view name can be _vw\_sales\_self\_service\_monthly\_revenue_
{% endhint %}
